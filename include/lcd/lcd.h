...
// Set horizontal screen or vertical screen
// display 0 or 1 for vertical screen
...
#define OLED_CS_Clr() gpio_bit_reset(GPIOB, GPIO_PIN_2)
...
#define OLED_CS_Set()
#else
#define OLED_SCLK_Clr() gpio_bit_reset(GPIOA, GPIO_PIN_5)
#define OLED_SCLK_Set() gpio_bit_set(GPIOA, GPIO_PIN_5)

#define OLED_SDIN_Clr() gpio_bit_reset(GPIOA, GPIO_PIN_7)
...
#define OLED_DC_Clr() gpio_bit_reset(GPIOB, GPIO_PIN_0)
#define OLED_DC_Set() gpio_bit_set(GPIOB, GPIO_PIN_0)

#if HAS_BLK_CNTL
#define OLED_BLK_Clr() gpio_bit_reset(GPIOA, GPIO_PIN_5)
#define OLED_BLK_Set() gpio_bit_reset(GPIOA, GPIO_PIN_5)
#else
#define OLED_BLK_Clr()
#define OLED_BLK_Set()
#endif
